...
#include "interfaces/msg/detail/direction__rosidl_typesupport_fastrtps_c.h"
...
using _Direction__ros_msg_type = interfaces__msg__Direction;
...
size_t get_serialized_size_interfaces__msg__Direction(
  const void * untyped_ros_message,
...
static uint32_t _Direction__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Direction(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__Direction(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Direction__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__Direction(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, Direction)() {
