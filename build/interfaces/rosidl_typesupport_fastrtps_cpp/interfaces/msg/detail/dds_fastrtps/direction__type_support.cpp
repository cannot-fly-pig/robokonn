...
#include "interfaces/msg/detail/direction__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Direction & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Direction & ros_message)
{
  // Member: direction
  cdr >> ros_message.direction;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Direction *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Direction *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Direction__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Direction)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Direction__handle;
}
