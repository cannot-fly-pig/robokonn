...
#include "interfaces/msg/detail/goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Goal & ros_message)
{
  // Member: diff
  cdr >> ros_message.diff;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Goal *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Goal)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Goal__handle;
}
