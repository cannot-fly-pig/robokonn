...
#include "interfaces/msg/detail/distance__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Distance & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Distance & ros_message)
{
  // Member: distance
  cdr >> ros_message.distance;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Distance *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Distance *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Distance__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Distance)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Distance__handle;
}
